...
const showMneu = (toggleId, navId) => {
    ...
    if (toggle && nav) {
        /*adiciona a class show-menu na div com a class nav__menu*/
...
function linkAction() {
    ...
    /*Quando um link for clicado a class show-menu é removida*/
...
function scrollHeader(){
    ...
    // Quando o scroll tiver um altura maior que 200 será adicionado a class scroll-header na tag Header
...
function scrollTop(){
    ...
    // Quando o scroll tiver um altura maior que 560 será adicionado a class scroll-top
